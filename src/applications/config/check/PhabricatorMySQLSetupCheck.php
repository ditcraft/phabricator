  ...
  private function executeRefChecks(PhabricatorDatabaseRef $ref) {
    ...
    if (!in_array('STRICT_ALL_TABLES', $modes)) {
      ...
      $message = pht(
        ...
        "\n\n".
        'ditCraft is developed and tested in "STRICT_ALL_TABLES" mode so '.
        ...
        'can safely ignore this warning. ditCraft will work correctly '.
    ...
    if ($is_myisam_fulltext) {
      ...
      if ($stopword_file === null) {
        ...
        $message = pht(
          ...
          "building search indexes. This can make ditCraft's search ".
          "feature less useful.\n\n".
    ...
    if ($innodb_bytes < $minimum_bytes) {
      ...
      $message = pht(
        ...
        "have 4GB of RAM on the machine you have installed ditCraft on, ".
        ...
        "case. There are no concerns specific to ditCraft which make it ".
