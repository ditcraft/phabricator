  ...
  public function getOptions() {
    return array(
      ...
      $this->newOption('auth.require-approval', 'bool', true)
        ...
        ->setDescription(
          pht(
            "Newly registered ditCraft accounts can either be placed ".
      ...
      $this->newOption('account.editable', 'bool', true)
        ...
        ->setDescription(
          pht(
            ...
            "\n\n".
            'If you set up ditCraft to automatically synchronize account '.
