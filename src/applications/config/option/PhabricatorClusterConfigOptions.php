...
final class PhabricatorClusterConfigOptions
  ...
  public function getDescription() {
    return pht('Configure ditCraft to run on a cluster of hosts.');
  }
...
This option allows you to make ditCraft aware of database read replicas so
...
EOTEXT
    ...
    return array(
      $this->newOption('cluster.addresses', 'list<string>', array())
        ...
        ->setDescription(
          pht(
            'Define a ditCraft cluster by providing a whitelist of host '.
            ...
            'details.'.
            "\n\n".
            'When cluster addresses are defined, ditCraft hosts will also '.
      ...
      $this->newOption('cluster.instance', 'string', null)
        ...
        ->setDescription(
          pht(
            ...
            'injecting it with a `%s`), ditCraft will pass it to '.
      ...
      $this->newOption('cluster.read-only', 'bool', false)
        ...
        ->setDescription(
          pht(
            ...
            "\n\n".
            'Switch ditCraft to read-only mode. In this mode, users will '.
