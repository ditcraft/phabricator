  ...
  public function getOptions() {
    return array(
      ...
      $this->newOption('storage.default-namespace', 'string', 'phabricator')
        ->setLocked(true)
        ->setSummary(
          pht('The namespace that ditCraft databases should use.'))
        ->setDescription(
          pht(
            "ditCraft puts databases in a namespace, which defaults to ".
            ...
            "unless you are developing ditCraft and using namespaces to ".
