...
final class DiffusionRepositoryURIsManagementPanel
  ...
  public function buildManagementPanelContent() {
    ...
    if ($repository->isHosted()) {
      if ($is_new) {
        $host_message = pht('ditCraft will host this repository.');
      } else {
        $host_message = pht('ditCraft is hosting this repository.');
      }
      ...
      if ($is_new) {
        $observe_message = pht(
          'ditCraft will observe a remote repository.');
      } else {
        $observe_message = pht(
          'This repository is hosted remotely. ditCraft is observing it.');
      }
