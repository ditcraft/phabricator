  ...
  public function handleRequest(AphrontRequest $request) {
    ...
    switch ($reason) {
      case PhabricatorEnv::READONLY_CONFIG:
        ...
        $body[] = pht(
          'An administrator has placed ditCraft into read-only mode.');
        $body[] = pht(
        ...
        $body[] = pht(
          ...
          'yelling "Hey! Why is ditCraft in read-only mode??!" using '.
      ...
      case PhabricatorEnv::READONLY_MASTERLESS:
        ...
        $body[] = pht(
          'ditCraft is currently configured with no writable ("master") '.
          'database, so it can not write new information anywhere. '.
          'ditCraft will run in read-only mode until an administrator '.
      ...
      case PhabricatorEnv::READONLY_UNREACHABLE:
        ...
        $body[] = pht(
          'ditCraft was unable to connect to the writable ("master") '.
        ...
        $body[] = pht(
          ...
          'ditCraft will recover momentarily.');
        $body[] = pht(
          'This may also indicate that a more serious failure has occurred. '.
          'If this interruption does not resolve on its own, ditCraft '.
      ...
      case PhabricatorEnv::READONLY_SEVERED:
        ...
        $body[] = pht(
          'ditCraft has consistently been unable to reach the writable '.
          '("master") database while processing recent requests.');
        $body[] = pht(
          'This likely indicates a severe misconfiguration or major service '.
          'interruption.');
        $body[] = pht(
          'ditCraft will periodically retry the connection and recover '.
